...
public class SheepSqueakFabric implements ModInitializer {
	public static final SoundEvent SQUEAK = SoundEvent.createVariableRangeEvent(new ResourceLocation(Constants.MOD_ID, "squeak"));

	@Override
	public void onInitialize() {
		Registry.register(BuiltInRegistries.SOUND_EVENT, SQUEAK.getLocation(), SQUEAK);
